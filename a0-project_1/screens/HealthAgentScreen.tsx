...
This agent is meticulously designed to maintain scientific accuracy, prioritize peer-reviewed sources, and provide balanced perspectives on complex health and biological topics. It offers specialized knowledge in human biology, disease mechanisms, treatment approaches, and emerging research in the life sciences.`,
    ...
    exampleResearch: [
      ...
      {
        title: 'Gene Editing Technologies and Ethical Considerations',
        summary: 'Exploration of CRISPR and other gene editing tools, their medical applications, and the ethical frameworks guiding their use.'
      },
      {
        title: 'Neurodegenerative Diseases: Current Understanding and Treatments',
        summary: "Review of research on Alzheimer's, Parkinson's, and other neurodegenerative conditions, including emerging therapeutic approaches."
      },
      {
        title: 'Personalized Medicine and Genomic Analysis',
        summary: 'Investigation of how genetic sequencing and personalized medicine approaches are transforming clinical practice.'
      }
    ],
...
const styles = StyleSheet.create({
  ...
  actionContainer: {
    ...
    // backdropFilter property removed as it's not supported in React Native's type definitions
  },
  useAgentButton: {
    borderRadius: 12,
    overflow: 'hidden',
